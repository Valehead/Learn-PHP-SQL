                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown2">
                                ...
                                <?php if(is_user_an_admin()){?><li><a href="/Learn-PHP-SQL/manage/admin.php" class="dropdown-item <?php if($_SERVER['SCRIPT_NAME']=="/Learn-PHP-SQL/manage/dashboard.php"){echo 'active';}; ?>">Admin</a></li><?php };?>
